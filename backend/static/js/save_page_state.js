...
export function saveStateToLocalStorage(document, processing) {
    var state = {
...
export function loadStateFromLocalStorage(document) {
...
export function loadCanvasState(canvas) {
...
export function loadLabelsState(document) {
